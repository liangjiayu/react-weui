    ...
    <div style={{ paddingTop: 30, paddingBottom: 60 }}>
      <DemoBlock title="成功">
        <div style={styles.box}>
          <Icon type="success" size="64px"></Icon>
      ...
      <DemoBlock title="普通警告">
        <div style={styles.box}>
          <Icon type="warn" size="64px" color="#ffc300"></Icon>
      ...
      <DemoBlock title="等待">
        <div style={styles.box}>
          <Icon type="waiting" size="64px"></Icon>
